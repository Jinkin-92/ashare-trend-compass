...
窗口口径：快窗口 10/21/63/126 四个交易日（约 2 周/1/3/6 月），
权重 [0.4, 0.3, 0.2, 0.1]（明显偏向近期）。
2026-08-11 校准：用 07-28/08-03/08-04/08-10 四日参考切片回放对比，
快窗口 MAE 12.8 显著优于 IBD 口径（21/63/126/252, 0.4/0.2/0.2/0.2）的 25.7，
趋势动物"强度"为纯横截面排名，对近期反转响应快，IBD 长窗口在反转行情系统性滞后。
"""
...
# 快窗口口径：2 周/1/3/6 月回望窗口（10/21/63/126 个交易日）
# 2026-08-11 校准切换（原 IBD 口径 21/63/126/252, 0.4/0.2/0.2/0.2）
DEFAULT_RS_WINDOWS: Tuple[int, ...] = (10, 21, 63, 126)
DEFAULT_RS_WEIGHTS: Tuple[float, ...] = (0.4, 0.3, 0.2, 0.1)
